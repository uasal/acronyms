...
## Editing Information
- Apply updates to the [`uasal_acronyms.tex`](uasal_acronyms.tex) file. 
...
- Update `Modified` section in [`uasal_acronyms.tex`](uasal_acronyms.tex) with the date you edited the file.
